import { Currency, ISOCurrencyCode } from '../Currency';
import { IMoney as Money, AbstractMoney } from './';
export default class ISOMoney extends AbstractMoney<ISOCurrencyCode> implements Money<ISOCurrencyCode> {
    /**
     ...
     * @internal
     */
    static getCurrencyUnit(currency: ISOCurrencyCode): Currency<ISOCurrencyCode>['units'];
}
//# sourceMappingURL=ISOMoney.d.ts.map